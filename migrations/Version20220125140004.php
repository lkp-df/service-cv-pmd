 ...
 */
final class Version20220125140004 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, user_for_cv_id INT NOT NULL, num_cv INT NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_B66FFE924FB246AC (user_for_cv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE model_cv (id INT AUTO_INCREMENT NOT NULL, cv_id INT DEFAULT NULL, designation VARCHAR(255) NOT NULL, prix NUMERIC(10, 0) NOT NULL, image VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_70232E25CFE419E2 (cv_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
